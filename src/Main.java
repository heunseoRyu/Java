...
public class Main {
    public static void main(String[] args) {
        ...
        while (true){
            ...
            System.out.println("고르세요. 0.종료 1.저장 2.저장목록 보기 3.검색 4.삭제 >> ");
            ...
            if (choice == 0){
                ...
                pNums.add(String.valueOf(pNum));
            }
            else if(choice == 2){
                for(Integer j=0;j<names.size();j++){
                    System.out.println(names.get(j) + ":" + pNums.get(j));
                }
            }
            else if(choice==3){
                int flag = 0;
                System.out.println("이름을 검색하시오 >> ");
